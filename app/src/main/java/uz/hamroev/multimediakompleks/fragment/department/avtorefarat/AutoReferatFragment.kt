...
import uz.hamroev.multimediakompleks.databinding.FragmentAutoReferatBinding
import uz.hamroev.multimediakompleks.model.Theme

class AutoReferatFragment : Fragment() {


    lateinit var binding: FragmentAutoReferatBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAutoReferatBinding.inflate(layoutInflater)
